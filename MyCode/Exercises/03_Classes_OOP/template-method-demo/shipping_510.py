...
# ANOTHER EXAMPLE OF TEMPLATE METHOD
    @property
    def volume_ft3(self):
...
class RefrigeratedShippingContainer(ShippingContainer):
    ...
    # CELSIUS SETTER DELEGATES TO REGULAR METHOD WHICH IS EASIER TO OVERRIDE
...
# OVERRIDE BUT STILL USE OLD ONE VIA super()
    def _calc_volume(self):
        return (
            super()._calc_volume()
...
class HeatedRefrigeratedShippingContainer(RefrigeratedShippingContainer):
    ...
    def _set_celsius(self, value): 
        ...
        # overriding Refrigerated _set_celsius
        # but still using it via super() to check other condition and to actually set it
